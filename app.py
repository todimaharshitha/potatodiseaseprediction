...
uploaded_image = st.file_uploader("Upload Potato Leaf Image",type=["jpg","png"])
if uploaded_image is not None:
    ...
    try:
        ...
        st.success("Plant is in {} condition {} and Prediction Confidence = {}%".format(predicted_class,"\n",round(confidence*100,2)))
